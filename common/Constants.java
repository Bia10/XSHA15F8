...
public class Constants
{
	...
	public static void onLevelUpSpells(Personnage perso,int lvl)
	{
		switch(perso.get_classe())
		{
			case CLASS_FECA:
				...
				if (Ancestra.CONFIG_ACTIV_NOUVEAU_SORT == true) //Si le nouveau sort est activé
				{
		...
		/*	//TODO: Classe zobal |By Return alias Porky|
			case CLASS_ZOBAL:
				...
				if(lvl == 550)
					perso.learnSpell(6010, 1,true,false);//Débandage
				if(lvl == 580)
	...
	public static ArrayList<Integer> JOB_ATELIER(int o) { //Les ateliers sur la map (pour livres de métiers)
		...
		ArrayList<Integer> a = new ArrayList<Integer>();
			...
			case 7012: // Enclume.
				...
				a.add(31);
				break;
				//FM.. En théorie, ils sont tous ensemble donc dès que j'en vois un, je les met tous.
			case 7020:
			case 7036:
				a.add(43);
				a.add(44);
