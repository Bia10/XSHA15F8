...
public class SocketManager {
	public static Map<Integer, String> waitingPackets = new TreeMap<Integer, String>();
	...
	public synchronized static void openQueue(PrintWriter out) {
		try {
			if (!waitingPackets.containsKey(out.hashCode())) {
				//waitings.add(out.hashCode());
				waitingPackets.put(out.hashCode(), "");
			}
		} catch (Exception e) {
			Ancestra.printDebug(e.getMessage());
		}
	}

	public synchronized static void clearQueue(PrintWriter out) {
		try {
			waitingPackets.remove(out.hashCode());
		} catch (Exception e) {
			Ancestra.printDebug(e.getMessage());
		}
	}

	public synchronized static void flushQueue(PrintWriter out) {
		try {
                        String packet = null;
			if (null != (packet = waitingPackets.remove(out.hashCode()))) {
                            send(out, packet);
	...
	public static void ENVIAR_CIJ_INFO_UNIRSE_PRISMA(Personnage pj, String str) {
	...
	public static void ENVIAR_CIV_CERRAR_INFO_CONQUISTA(Personnage pj) {
		String packet = "CIV";
		send(pj, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	...
	public static void ENVIAR_CA_MENSAJE_ATAQUE_PRISMA(Personnage perso,
			String str) {
	...
	public static void ENVIAR_OAKO_APARECER_OBJETO(Personnage perso, Objet obj) {
		String packet = (new StringBuilder("OAKO")).append(obj.parseItem())
				.toString();
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	...
	public static void ENVIAR_CS_MENSAJE_SOBREVIVIO_PRISMA(Personnage perso,
			String str) {
	...
	public static void ENVIAR_CD_MENSAJE_MURIO_PRISMA(Personnage perso,
			String str) {
	...
	public static void ENVIAR_ECK_PANEL_DE_INTERCAMBIOS(Personnage perso,
			int tipo, String str) {
		String packet = (new StringBuilder("ECK")).append(tipo).toString();
		if (!str.equals(""))
			packet = (new StringBuilder(String.valueOf(packet))).append("|")
					.append(str).toString();
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	...
	public static void ENVIAR_ECK_PANEL_DE_INTERCAMBIOS(PrintWriter out,
			int tipo, String str) {
		String packet = (new StringBuilder("ECK")).append(tipo).toString();
		if (!str.equals(""))
			packet = (new StringBuilder(String.valueOf(packet))).append("|")
	...
	public static void ENVIAR_QL_LISTA_MISIONES(Personnage perso, String str) {
	...
	public static void ENVIAR_QS_PASOS_RECOMPENSA_MISION(Personnage perso,
			String str) {
	...
	public static void ENVIAR_AlE_CAMBIAR_NOMBRE(PrintWriter out, String letra) {
		String packet = (new StringBuilder("AlE")).append(letra).toString();
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	}
	public static void ENVIAR_aM_MENSAJE_ALINEACION_AREA(Personnage perso,
			String str) {
	...
	public static void PACKET_POPUP_VOTE(Personnage perso, String str) {
		
		String packet = "BAIO" + str;
		//SQLManager.UPDATE_VOTE_END_POINTS(P.get_compte());
		send(perso, packet);
		
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("GAME: Send>>  " + packet);
	}
public static void PACKET_POPUP_ALERTE(String msg) {
	...
	public static void PACKET_POPUP_DEPART(Personnage perso, String str) {
		String packet = "BAIO" + str;
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("GAME: Send>>  " + packet);
	}
	public static void GAME_SEND_MAP_PRISMAS(Carte mapa, objects.Prisma prisma) {// envia
		
String packet = prisma.getGMPrisma();
for (Personnage z : mapa.getPersos())
send(z, packet);
if (Ancestra.CONFIG_DEBUG)
GameServer.addToSockLog("Game: Fight: Send>>" + packet);
}
	public static void ENVIAR_Wp_MENU_PRISMA(Personnage perso) {
	...
	public static void ENVIAR_Ww_CERRAR_PRISMA(Personnage out) {
		String packet = "Ww";
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: ALL("
	...
	public static void ENVIAR_GM_PRISMAS_EN_MAPA(PrintWriter out, Carte mapa) {// envia
		// informacion
		// de
		// todos
		// mercantes
		...
		// 1
		// mapa
String packet = mapa.getPrismaGMPacket();
...
GameServer.addToSockLog("Game: Send>>" + packet);
	...
	public static void ENVIAR_CW_INFO_MUNDO_CONQUISTA(Personnage pj, String str) {
		String packet = "CW" + str;
		send(pj, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	}
	public static void ENVIAR_CB_BONUS_CONQUISTA(Personnage pj, String str) {
	...
	public static void ENVIAR_Cb_BALANCE_CONQUISTA(Personnage pj, String str) {
		String packet = "Cb" + str;
		send(pj, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Fight: Send>>" + packet);
	...
	public static void ENVIAR_As_STATS_DEL_PJ(Personnage perso) {
		String packet = perso.getAsPacket();
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Fight: Send>>" + packet);
	}
	public static void ENVIAR_am_MENSAJE_ALINEACION_SUBAREA(Personnage perso,
			String str) {
		String packet = "am" + str;
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void ENVIAR_Cp_INFO_ATACANTES_PRISMA(Personnage perso,
			String str) {// info de recaudador player
		String packet = "Cp" + str;
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			GameServer.addToSockLog("Game: Send>>" + packet);
	}
	public static void GAME_SEND_MAP_ENVIAR_CIJ_INFO_UNIRSE_PRISMANPCS_GMS_PACKETS(PrintWriter out,
			Carte carte) {
	...
	public static void ENVIAR_CP_INFO_DEFENSORES_PRISMA(Personnage perso,
			String str) {// info de recaudador player
		String packet = "CP" + str;
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void GAME_SEND_MAP_NPCS_GMS_PACKETS(Personnage p, Carte carte)
	{
	...
	public static void GAME_SEND_EV_PACKET(Personnage out) {
		String packet = "EV";
		send(out, packet);
	}
	...
	public static void GAME_SEND_OCO_PACKET(Personnage out, Objet obj) {
    ...
    public static void GAME_SEND_cMK_PACKET_INCARNAM_CHAT(Personnage perso, String suffix, int guid, String name, String msg) 
    { 
    	String packet = "cMK" + suffix + "|" + guid + "|" + name + "|" + msg; 
    	if (perso.get_lvl() > 15) 
    	{ 
	...
	public static void GAME_SEND_CIN_Packet(Personnage perso, String num) { // Jouer une cinématique
		send(perso,"GA;2;" + perso.get_GUID() + ";" + num);
	}
	
	public static void GAME_SEND_TB_Packet(Personnage perso) { // Jouer la cinématique de départ
		send(perso,"TB");
	}
	
	public static void GAME_SEND_Carte_ACTUALIZAR_CELDA(Carte Carte, String str) { //Actualiser une cellule
		String packet = "GDO+" + str;
		for (Personnage z : Carte.getPersos())
			send(z, packet);
		if (Ancestra.CONFIG_DEBUG)
			Ancestra.printDebug("GAME: SEND>>  " + packet);
	}
	
	public static void ENVIAR_GDO_PONER_OBJETO_CRIA_EN_MAPA(Carte mapa, String str) { //Actualiser une cellule 3.0
		String packet = "GDO+" + str;
		for (Personnage z : mapa.getPersos())
			send(z, packet);
		if (Ancestra.CONFIG_DEBUG)
	...
	public static void ENVIAR_OR_ELIMINAR_OBJETO(Personnage perso, int id) {
		String packet = "OR" + id;
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			Ancestra.printDebug("Game: Send>> " + packet);
	...
	public static void GAME_SEND_EL_MOUNT_PACKET(PrintWriter out, Dragodinde drago) { // Inventaire dinde : Liste des objets
	...
	public static void GAME_SEND_BAIO_PACKET(Personnage perso, String str) { // Afficher le panel d'info
		String packet = "BAIO" + str;
		send(perso, packet);
		if (Ancestra.CONFIG_DEBUG)
			Ancestra.printDebug("Game: Send>> " + packet);
	...
	public static void GAME_SEND_EJ_PACKET(Personnage perso, int metid, int pid, StatsMetier sm) { //Regarder un livre de métier
		Personnage p = World.getPersonnage(pid);
		if(p == null)return;
	...
	public static void GAME_SEND_Ag_PACKET(PrintWriter out, int idObjeto, String codObjeto) { //Cadeau à la connexion
	...
	public static void GAME_SEND_AGK_PACKET(PrintWriter out) { //Cadeau à la connexion
		String packet = "AGK";
		send(out, packet);
		if (Ancestra.CONFIG_DEBUG)
			Ancestra.printDebug("Game: Send>> " + packet);
	...
	public static void GAME_SEND_dCK_PACKET(Personnage out, String id) //Ouvrir un livre
	{
		String packet = "dCK"+id;
		send(out,packet);
		if(Ancestra.CONFIG_DEBUG)
