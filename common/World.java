...
public class World {
	...
	public static Map<Integer,StatsMetier> upFPc = Collections.synchronizedMap(new HashMap<Integer,StatsMetier>()); // Pêcheurman... 42.. Sydney... avenue Walaby
	...
	public static void saveAll(Personnage saver) //Supressions des Thread.sleep complètement inutiles.
	{
