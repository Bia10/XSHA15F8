...
public class Compte {
	...
	private int _QuoteJail = 0;
	private int _EventPoints = 0;
	private long _endban = 0;
	private int _vote = 0;
	...
	public Compte(int aGUID,String aName,String aPass, String aPseudo,String aQuestion,String aReponse,int aGmLvl, int vip, boolean aBanned, int aQuoteJail, int aEventPoints, int aendban, int aVote, int aPoints, String aLastIp, String aLastConnectionDate,String bank,int bankKamas, String friends, String enemy, int cadeau)
	{
		this._GUID 		= aGUID;
		this._name 		= aName;
		this._pass		= aPass;
		...
		this._QuoteJail = aQuoteJail;
		this._EventPoints = aEventPoints;
		this._endban 	= aendban;
		this._vote 		= aVote;
	...
	public void mute(boolean b, int time)
	{
		...
		{
			_muteTimer = new Timer(time,new ActionListener()
			{
		...
		}else
		{
			...
			_muteTimer.setInitialDelay(time); 
			_muteTimer.start(); 
		}
	}
	...
	public boolean isBanned() {
        ...
        public long getEndBan()
        {
            return _endban;
        }
        public void setEndBan(long endbn)
        {
             this._endban = endbn;
        }
    public int get_vote()
	...
	public void setQuoteJail(int QuotaJail) {
		_QuoteJail = QuotaJail;
	}
	public  void set_bankKamass(long nrb) {
		_bankKamas = nrb;
	}
	public  int getQuoteJail(){
		return _QuoteJail;
	}
	...
	public void openQueue() {
		SocketManager.openQueue(_gameThread.get_out());
	}

	@SuppressWarnings("unused")
	private void clearQueue() //it's private, don't change it
	{
		SocketManager.clearQueue(_gameThread.get_out());
	}
	public void flushQueue() {
		SocketManager.flushQueue(_gameThread.get_out());
	}
}
