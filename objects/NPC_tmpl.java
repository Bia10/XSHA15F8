...
public class NPC_tmpl {
	...
	public static class NPC
	{
		...
		public String parseGM(Personnage p)
		{
		...
		public String parseGM() {
			...
			sock += (_template.get_color1() != -1 ? Integer
					.toHexString(_template.get_color1()) : "-1") + ";";
			sock += (_template.get_color2() != -1 ? Integer
					.toHexString(_template.get_color2()) : "-1") + ";";
			sock += (_template.get_color3() != -1 ? Integer
					.toHexString(_template.get_color3()) : "-1") + ";";
			sock += _template.get_acces() + ";";
			sock += (_template.get_extraClip() != -1 ? (_template
					.get_extraClip()) : ("")) + ";";
			sock += _template.get_customArtWork();
			return sock;
		}
	...
	public static class NPC_reponse
	{
		...
		{
			for(Action act : _actions)act.apply(perso, null, -1, this._id);//on passe l'id de la reponse sans cellid
		}
